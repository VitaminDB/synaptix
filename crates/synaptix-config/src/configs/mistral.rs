...
pub struct MistralConfig {
    #[serde(default = "MistralConfig::default_vocab_size")]
    pub vocab_size: usize,
    #[serde(default = "MistralConfig::default_hidden_size")]
    pub hidden_size: usize,
    #[serde(default = "MistralConfig::default_intermediate_size")]
    pub intermediate_size: usize,
    #[serde(default = "MistralConfig::default_num_hidden_layers")]
    pub num_hidden_layers: usize,
    #[serde(default = "MistralConfig::default_num_attention_heads")]
    pub num_attention_heads: usize,
    #[serde(default = "MistralConfig::default_num_key_value_heads")]
    pub num_key_value_heads: usize,
    #[serde(default = "MistralConfig::default_max_position_embeddings")]
    pub max_position_embeddings: usize,
    #[serde(default = "MistralConfig::default_rms_norm_eps")]
    pub rms_norm_eps: f64,
    #[serde(default = "MistralConfig::default_rope_theta")]
    pub rope_theta: f64,
    #[serde(default)]
    ...
    #[serde(default = "MistralConfig::default_hidden_act")]
    pub hidden_act: String,
    #[serde(default)]
    pub rope_scaling: Option<crate::configs::llama::RopeScaling>,
    #[serde(default = "MistralConfig::default_sliding_window")]

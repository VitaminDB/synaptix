...
pub struct InternLmConfig {
    #[serde(default = "InternLmConfig::default_vocab_size")]
    pub vocab_size: usize,
    #[serde(default = "InternLmConfig::default_hidden_size")]
    pub hidden_size: usize,
    #[serde(default = "InternLmConfig::default_intermediate_size")]
    pub intermediate_size: usize,
    #[serde(default = "InternLmConfig::default_num_hidden_layers")]
    pub num_hidden_layers: usize,
    #[serde(default = "InternLmConfig::default_num_attention_heads")]
    pub num_attention_heads: usize,
    #[serde(default = "InternLmConfig::default_num_key_value_heads")]
    pub num_key_value_heads: usize,
    #[serde(default = "InternLmConfig::default_max_position_embeddings")]
    pub max_position_embeddings: usize,
    #[serde(default = "InternLmConfig::default_rms_norm_eps")]
    pub rms_norm_eps: f64,
    #[serde(default = "InternLmConfig::default_rope_theta")]
    pub rope_theta: f64,
    #[serde(default)]
    ...
    #[serde(default = "InternLmConfig::default_hidden_act")]
    pub hidden_act: String,
    #[serde(default)]
    pub rope_scaling: Option<crate::configs::llama::RopeScaling>,
    #[serde(default = "InternLmConfig::default_attn_implementation")]
    pub attn_implementation: String,
}

impl InternLmConfig {
    fn default_vocab_size() -> usize { 103168 }
    ...
    fn default_attn_implementation() -> String { "flash_attention_2".into() }
}

impl Default for InternLmConfig {
    fn default() -> Self {
        Self {
            ...
            rope_scaling: None,
            attn_implementation: Self::default_attn_implementation(),
        }
    }
}

...
pub struct YiConfig {
    #[serde(default = "YiConfig::default_vocab_size")]
    pub vocab_size: usize,
    #[serde(default = "YiConfig::default_hidden_size")]
    pub hidden_size: usize,
    #[serde(default = "YiConfig::default_intermediate_size")]
    pub intermediate_size: usize,
    #[serde(default = "YiConfig::default_num_hidden_layers")]
    pub num_hidden_layers: usize,
    #[serde(default = "YiConfig::default_num_attention_heads")]
    pub num_attention_heads: usize,
    #[serde(default = "YiConfig::default_num_key_value_heads")]
    pub num_key_value_heads: usize,
    #[serde(default = "YiConfig::default_max_position_embeddings")]
    pub max_position_embeddings: usize,
    #[serde(default = "YiConfig::default_rms_norm_eps")]
    pub rms_norm_eps: f64,
    #[serde(default = "YiConfig::default_rope_theta")]
    pub rope_theta: f64,
    #[serde(default)]
    ...
    #[serde(default = "YiConfig::default_hidden_act")]
...
impl YiConfig {
    fn default_vocab_size() -> usize { 64000 }
    ...
    fn default_rope_theta() -> f64 { 5000000.0 }
